        ...
        <nav class="sidebar-nav">
            <ul id="sidebarnav">
                ...
                @endif
                    ...
                    <li class="sidebar-item">
                        <a class="sidebar-link" href="{{route('admin.listingCategory')}}" aria-expanded="false">
                    ...
                    <li class="sidebar-item">
                        <a class="sidebar-link" href="{{route('admin.viewListings')}}" aria-expanded="false">
                            <i class="fa fa-list-ol text-cyan" aria-hidden="true"></i>
                            <span class="hide-menu">@lang('User Listings')</span>
                        </a>
                    </li>

                    <li class="sidebar-item">
                        <a class="sidebar-link" href="{{route('admin.wishList')}}" aria-expanded="false">
                            <i class="fa fa-heart text-info" aria-hidden="true"></i>
                            <span class="hide-menu">@lang('WishList')</span>
                        </a>
                    </li>
                    <li class="sidebar-item">
                        <a class="sidebar-link" href="{{route('admin.productEnquiry')}}" aria-expanded="false">
                            <i class="fa fa-question text-danger" aria-hidden="true"></i>
                            <span class="hide-menu">@lang('Product Enquiry')</span>
                        </a>
                    </li>
                    <li class="sidebar-item">
                        <a class="sidebar-link" href="{{route('admin.listingAnalytics')}}" aria-expanded="false">
                            <i class="fas fa-chart-line text-warning"></i>
                            <span class="hide-menu">@lang('Analytics')</span>
                        </a>
                    </li>
                    <li class="sidebar-item">
                        <a class="sidebar-link" href="{{route('admin.listingSettings')}}" aria-expanded="false">
                    ...
                    @if(adminAccessRoute(config('role.amenities.access.view')))
                        <li class="nav-small-cap"><span class="hide-menu">@lang('Amenities')</span></li>
                        <li class="sidebar-item">
                    ...
                    @if(adminAccessRoute(config('role.place.access.view')))
                        <li class="nav-small-cap"><span class="hide-menu">@lang('Place')</span></li>
                        <li class="sidebar-item">
                            <a class="sidebar-link" href="{{route('admin.place')}}" aria-expanded="false">
                                <i class="fa fa-location-arrow text-purple" aria-hidden="true"></i>
                                <span class="hide-menu">@lang('Place List')</span>
                            </a>
                        </li>
                        <li class="list-divider"></li>
                    @endif
                    ...
                    @if(adminAccessRoute(config('role.claim_business.access.view')))
                        <li class="nav-small-cap"><span class="hide-menu">@lang('Claim Business')</span></li>
                        <li class="sidebar-item">
                            <a class="sidebar-link" href="{{route('admin.claimBusiness')}}" aria-expanded="false">
                                <i class="fa fa-thumbs-down text-green" aria-hidden="true"></i>
                                <span class="hide-menu">@lang('Claim List')</span>
                            </a>
                        </li>
                        <li class="list-divider"></li>
                    @endif
                    ...
                    @if(adminAccessRoute(config('role.contact_message.access.view')))
                        <li class="nav-small-cap"><span class="hide-menu">@lang('Listing Message')</span></li>
                        <li class="sidebar-item">
                            <a class="sidebar-link" href="{{ route('admin.contactMessage') }}" aria-expanded="false">
                                <i class="fas fa-envelope-open text-yellow"></i>
                                <span class="hide-menu">@lang('Message List')</span>
                            </a>
                        </li>
                    @endif
                ...
                @if(adminAccessRoute(array_merge(config('role.website_controls.access.view'), config('role.language_settings.access.view'))))
                    ...
                    @if(adminAccessRoute(config('role.website_controls.access.view')))
                        ...
                        <li class="sidebar-item">
                            <a class="sidebar-link" href="{{route('admin.fileStorage')}}" aria-expanded="false">
                                <i class="fa fa-database text-warning"></i>
                                <span class="hide-menu">@lang('File Storage')</span>
                            </a>
                        </li>
                ...
                @endif
                    ...
                    <li class="list-divider"></li>
                    <li class="nav-small-cap"><span class="hide-menu">@lang('Version 3.0')</span></li>
            </ul>
        </nav>
    </div>
</aside>
