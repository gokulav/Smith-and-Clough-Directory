                    ...
                    <form method="post" action="{{ route('admin.content.store', [$content,0]) }}" enctype="multipart/form-data">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4 source-parent">
                                <div class="form-group">
                                    ...
                                    <div class="image-input ">
                                        ...
                                        <img id="image_preview_container" class="preview-image" src="{{getFile(config('location.content.path').(isset($templateMedia->description->{$name}) ? $templateMedia->description->{$name} : ''))}}" alt="@lang('preview image')">
                                    </div>
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    <label for="{{ $name }}"> @lang(ucwords(str_replace('_',' ',$name))) </label>
                                    <input type="{{ $type }}" name="{{ $name }}[{{ 0 }}]" class="form-control  @error($name.'.0') is-invalid @enderror" value="{{ old($name.'.0', isset($templateMedia->description->{$name}) ? $templateMedia->description->{$name} : '') }}">
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <div class="input-group input-group-sm">
                                        <input type="text" name="{{ $name }}[{{ 0 }}]" class="form-control icon @error($name.'.0') is-invalid @enderror" value="{{ old($name.'.0', isset($templates[0]) ? $templates[0][0]->description->{$name} : '') }}">
                            ...
                            <form method="post" action="{{ route('admin.content.store', [$content,$language->id]) }}" enctype="multipart/form-data">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            <label for="{{ $name }}"> @lang(ucwords(str_replace('_',' ',$name))) </label>
                                            <input type="{{ $type }}" name="{{ $name }}[{{ $language->id }}]" class="form-control  @error($name.'.'.$language->id) is-invalid @enderror" value="{{ old($name.'.'.$language->id, isset($templates[$language->id]) ? $templates[$language->id][0]->description->{$name} : '') }}">
                                            <div class="invalid-feedback">
                                    ...
                                    <div class="col-md-4 source-parent">
                                        <div class="form-group">
                                            ...
                                            <div class="image-input ">
                                                ...
                                                <img id="image_preview_container" class="preview-image" src="{{getFile(config('location.default'))}}" alt="@lang('preview image')">
                                            </div>
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            <label for="{{ $name }}"> @lang(ucwords(str_replace('_',' ',$name))) </label>
                                            <input type="{{ $type }}" name="{{ $name }}[{{ $language->id }}]" class="form-control  @error($name.'.'.$language->id) is-invalid @enderror" value="{{ old($name.'.'.$language->id, isset($templateMedia->description->{$name}) ? $templateMedia->description->{$name} : '') }}">
                                            <div class="invalid-feedback">
                                                @error($name.'.'.$language->id) @lang($message) @enderror
                                            </div>
                                            <div class="valid-feedback"></div>
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            <label for="{{ $name }}">@lang(ucwords(str_replace('_',' ',$name)))</label>
                                            <textarea class="form-control  summernote @error($name.'.'.$language->id) is-invalid @enderror" name="{{ $name }}[{{ $language->id }}]" rows="5">{{ old($name.'.'.$language->id, isset($templates[$language->id]) ? $templates[$language->id][0]->description->{$name} : '') }}</textarea>
                                            <div class="invalid-feedback">
                                                @error($name.'.'.$language->id) @lang($message) @enderror
                                            </div>
                                        </div>
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <div class="input-group">
                                                <input type="text" name="{{ $name }}[{{ $language->id }}]" class="form-control icon @error($name.'.'.$language->id) is-invalid @enderror" value="{{ old($name.'.'.$language->id, isset($templates[$language->id]) ? $templates[$language->id][0]->description->{$name} : '') }}">
                                                <div class="input-group-append">
                                                    <button class="btn btn-outline-primary iconPicker" data-icon="fas fa-home" role="iconpicker"></button>
                                                </div>
