...
@section('content')
    <div class="container-fluid">
        <div class="bd-callout bd-callout-warning">
            <i class="fas fa-info-circle mr-2"></i> @lang('After changes logo/seo. Please clear your browser\'s cache to see changes.') </div>
                ...
                <div class="card card-primary shadow">
                    <div class="card-body">
                        ...
                        <div class="tab-content">
                            <div id="home" class="mt-3 container tab-pane {{ $errors->has('profile') ? 'active' : ($errors->has('password') ? '' : 'active') }}">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="image-input">
                                                    ...
                                                    <img id="image_preview_container" class="preview-image"
                                                         src="{{ getFile(config('basic.default_file_driver'),config('basic.logo_image')) ? : 0 }}"
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="image-input">
                                                    ...
                                                    <img id="adminLogo_preview_container" class="preview-image"
                                                         src="{{ getFile(config('basic.default_file_driver'),config('basic.admin_logo')) ? : 0 }}"
                                                         alt="preview image">
                                                </div>
                                                @error('image')
                                                <span class="text-danger">{{$message}}</span>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="image-input">
                                                    ...
                                                    <img id="favicon_preview_container" class="preview-image"
                                                         src="{{ getFile(config('basic.default_file_driver'),config('basic.favicon_image')) ? : 0 }}"
                                                         alt="preview image">
                                                </div>
                                                @error('favicon')
                                                <span class="text-danger">{{$message}}</span>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="image-input ">
                                                    ...
                                                    <img id="meta_image_preview_container" class="preview-image"
                                                         src="{{ getFile(config('basic.default_file_driver'),config('basic.logo_meta')) ? : 0 }}"
                                                         alt="preview image">
                                                </div>
                                                @error('favicon')
                                                <span class="text-danger">{{$message}}</span>
