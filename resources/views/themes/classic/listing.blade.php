    ...
    <div class="container-fluid">
        <div class="row">
                        ...
                        <div class="filter-box">
                            ...
                            <div class="input-group mb-3">
                                <select class="js-example-basic-single form-control" name="location">
                                    ...
                                    <option value="all" @if(request()->location == 'all') selected @endif>@lang('All Location')
                                    </option>

                                    @foreach($all_places as $place)
                                    <option class="m-0" value="{{ $place->id }}" @if(request()->location == $place->id) selected @endif>@lang(optional($place->details)->place)
                                    </option>
                                    @endforeach
                                </select>
                            </div>
                            ...
                            <div class="input-group mb-3">
                                <select class="listing__category__select2 form-control" name="category[]" multiple>
                                    <option value="all" @if(request()->category && in_array('all', request()->category))
                                        selected
                                        @endif>@lang('All Category')</option>
                                    @foreach($all_categories as $category)
                                    <option value="{{ $category->id }}" @if(request()->category && in_array($category->id, request()->category))
                                        selected
                        ...
                        <div class="filter-box">
                            ...
                            <div class="input-group mb-3">
                                <select class="js-example-basic-single form-control" name="user">
                                    ...
                                    <option value="{{ $user->id }}" @if(request()->user == $user->id) selected @endif>@lang($user->fullname)
                                    </option>
                                    @endforeach
                                </select>
                            </div>
                        ...
                        <div class="filter-box">
                            ...
                            <div class="check-box">
                                <div class="form-check">
                                    <input class="form-check-input" type="checkbox" value="5" name="rating[]" id="check1" @if(isset(request()->rating))
                                ...
                                <div class="form-check">
                                    <input class="form-check-input" type="checkbox" value="4" name="rating[]" id="check2" @if(isset(request()->rating))
                                    @foreach(request()->rating as $data)
                                ...
                                <div class="form-check">
                                    <input class="form-check-input" type="checkbox" value="3" name="rating[]" id="check3" @if(isset(request()->rating))
                                    @foreach(request()->rating as $data)
                                ...
                                <div class="form-check">
                                    <input class="form-check-input" type="checkbox" value="2" name="rating[]" id="check4" @if(isset(request()->rating))
                                    @foreach(request()->rating as $data)
                                ...
                                <div class="form-check">
                                    <input class="form-check-input" type="checkbox" value="1" name="rating[]" id="check5" @if(isset(request()->rating))
                                    @foreach(request()->rating as $data)
            ...
            <div class="col-xl-9 col-lg-9 col-sm-12 my-4">
                @if( 0 <count($all_listings)) <div class="row g-4">
                    ...
                    <div class="col-xl-4 col-lg-4 col-md-4 col-sm-6 col-xs-12">
                        <div class="listing-box listing-map-box" data-lat="{{ $listing->lat }}" data-long="{{ $listing->long }}" data-title="@lang( Str::limit($listing->title, 30))" data-image="{{ getFile($listing->driver, $listing->thumbnail) }}" data-location="@lang($listing->address)" data-route="{{ route('listing-details',[slug($listing->title), $listing->id]) }}">
                            <div class="img-box">
                            ...
                            <div class="text-box">
                                <div class="review">
                                    ...
                                    @for($j; $j < 5; $j++) <i class="far fa-star"></i>
                                        @endfor
                                        @endif
