                                    ...
                                    <div class="col-md-1">
                                        <div class="form-group">
                                            <a href="javascript:void(0);"
                                               class="btn btn-outline-primary rounded btn-sm addHeaderData"><i class="fas fa-plus"></i></a>
                                        </div>
                                    </div>
                                </div>
                            <?php else: ?>
...
unset($__errorArgs, $__bag); ?></div>
                                        ...
                                        <div class="col-md-1">
                                            <div class="form-group">
                                                <?php if($loop->first): ?>
                                                    <a href="javascript:void(0);"
                                                       class="btn btn-outline-primary btn-sm rounded addHeaderData"><i
                                                            class="fas fa-plus"></i></a>
                                                <?php else: ?>
                                                    <a href="javascript:void(0);"
                                                       class="btn btn-outline-danger btn-sm rounded removeDiv"><i
                        ...
                        <div class="paramsWrapper mt-2 ">
                            <?php if(is_null($paramData)): ?>
                                <div class="row">
                                    ...
                                    <div class="col-md-1">
                                        <div class="form-group">
                                            <a href="javascript:void(0);" class="btn btn-outline-primary rounded btn-sm addParams"><i
                                                    class="fas fa-plus"></i></a>
                                        </div>
                                    </div>
                                </div>
...
unset($__errorArgs, $__bag); ?></div>
                                        ...
                                        <div class="col-md-1">
                                            <div class="form-group">
                                                <?php if($loop->first): ?>
                                                    <a href="javascript:void(0);"
                                                       class="btn btn-outline-primary rounded btn-sm addParams"><i
                                                            class="fas fa-plus"></i></a>
                                                <?php else: ?>
                                                    <a href="javascript:void(0);"
                                                       class="btn btn-outline-danger rounded btn-sm removeDiv"><i
                                                            class="fas fa-minus"></i></a>
                                                <?php endif; ?>
                                            </div>
                                        </div>
                        ...
                        <div class="formDataWrapper mt-2">
                            <?php if(is_null($formData)): ?>
                                <div class="row">
                                    ...
                                    <div class="col-md-1">
                                        <div class="form-group">
                                            <a href="javascript:void(0);" class="btn btn-outline-primary rounded btn-sm addFormData"><i
                                                    class="fas fa-plus"></i></a>
                                        </div>
                                    </div>
                                </div>
...
unset($__errorArgs, $__bag); ?></div>
                                        ...
                                        <div class="col-md-1">
                                            <div class="form-group">
                                                <?php if($loop->first): ?>
                                                    <a href="javascript:void(0);"
                                                       class="btn btn-outline-primary rounded btn-sm addFormData"><i
                                                            class="fas fa-plus"></i></a>
                                                <?php else: ?>
                                                    <a href="javascript:void(0);"
                                                       class="btn btn-outline-danger rounded btn-sm removeDiv"><i
    ...
    <div class="paramHtml d-none">
        <div class="row">
            ...
            <div class="col-md-1">
                <div class="form-group">
                    <a href="#" class="btn btn-outline-danger rounded btn-sm removeDiv"><i class="fas fa-minus"></i></a>
                </div>
            </div>
        </div>
    </div>
...
<?php $__env->startPush('js'); ?>
    ...
    <script>
        ...
        $(document).ready(function () {
            ...
            $(addHeaderData).click("on",function () {
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/sites/28a/2/26dd80d363/public_html/resources/views/admin/sms-template/config.blade.php ENDPATH**/ ?>