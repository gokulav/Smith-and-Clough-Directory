...
<?php $__env->startSection('content'); ?>
    <div class="container-fluid">
        <div class="bd-callout bd-callout-warning">
            <i class="fas fa-info-circle mr-2"></i> <?php echo app('translator')->get('After changes logo/seo. Please clear your browser\'s cache to see changes.'); ?> </div>
                ...
                <div class="card card-primary shadow">
                    <div class="card-body">
                        <ul class="nav nav-tabs" role="tablist">
                            <li class="nav-item">
                                <a class="nav-link <?php echo e($errors->has('profile') ? 'active' : ($errors->has('password') ? '' : 'active')); ?>"
                                   data-toggle="tab" href="#home"><?php echo app('translator')->get('Logo & Favicon'); ?></a>
                            </li>
                            <li class="nav-item">
                        ...
                        <div class="tab-content">
                            <div id="home" class="mt-3 container tab-pane <?php echo e($errors->has('profile') ? 'active' : ($errors->has('password') ? '' : 'active')); ?>">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="image-input">
                                                    ...
                                                    <img id="image_preview_container" class="preview-image"
                                                         src="<?php echo e(getFile(config('basic.default_file_driver'),config('basic.logo_image')) ? : 0); ?>"
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="image-input">
                                                    ...
                                                    <img id="adminLogo_preview_container" class="preview-image"
                                                         src="<?php echo e(getFile(config('basic.default_file_driver'),config('basic.admin_logo')) ? : 0); ?>"
                                                         alt="preview image">
                                                </div>
                                                <?php $__errorArgs = ['image'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="image-input">
                                                    ...
                                                    <img id="favicon_preview_container" class="preview-image"
                                                         src="<?php echo e(getFile(config('basic.default_file_driver'),config('basic.favicon_image')) ? : 0); ?>"
                                                         alt="preview image">
                                                </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="image-input ">
                                                    ...
                                                    <img id="meta_image_preview_container" class="preview-image"
                                                         src="<?php echo e(getFile(config('basic.default_file_driver'),config('basic.logo_meta')) ? : 0); ?>"
                                                         alt="preview image">
                                                </div>
                                                <?php $__errorArgs = ['favicon'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/sites/28a/2/26dd80d363/public_html/resources/views/admin/logo.blade.php ENDPATH**/ ?>