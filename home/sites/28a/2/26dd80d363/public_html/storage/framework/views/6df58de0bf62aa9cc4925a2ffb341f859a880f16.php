        ...
        <div class="col-md-6">
            <div class="card card-primary m-0 m-md-4 my-4 m-md-0 shadow">
                <div class="card-body">
                    ...
                    <a href="https://www.youtube.com/watch?v=S0Ddv3UxhWg" target="_blank" class="btn btn-primary btn-sm mb-2 text-white float-right" type="button">
                    ...
                    <div class="table-responsive">
                        <table class="table">
                            ...
                            <tbody>
                            <tr>
                                <td><pre><?php echo app('translator')->get(' [[name]] '); ?></pre></td>
                                <td> <?php echo app('translator')->get("User's Name will replace here."); ?> </td>
                            </tr>
                            <tr>
                                <td><pre><?php echo app('translator')->get(' [[message]] '); ?></pre></td>
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group ">
                            ...
                            <input type="text" name="sender_email" class="form-control" placeholder="<?php echo app('translator')->get('Email Address'); ?>" value="<?php echo e($control->sender_email); ?>">
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="col-md-6">
                        <div class="form-group ">
                            ...
                            <input type="text" name="sender_email_name" class="form-control" placeholder="<?php echo app('translator')->get('Email Address'); ?>" value="<?php echo e($control->sender_email_name); ?>">
                    ...
                    <div class="col-md-3 d-none">
                        <div class="form-group">
                            ...
                            <select name="email_method" class="form-control" >
                                <option value="sendmail" <?php if(old('email_method', $control->email_configuration->name) == "sendmail"): ?>  selected <?php endif; ?>><?php echo app('translator')->get('PHP Mail'); ?></option>
                                <option value="smtp" <?php if( old('email_method', $control->email_configuration->name) == "smtp"): ?> selected <?php endif; ?>><?php echo app('translator')->get('SMTP'); ?></option>
                            </select>
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="form-row mt-4 d-none configForm" id="smtp">
                    ...
                    <div class="form-group col-md-4">
                        ...
                        <input type="text" class="form-control" placeholder="<?php echo app('translator')->get('Host or Email Address'); ?>" name="smtp_host" value="<?php echo e(old('smtp_host', $control->email_configuration->smtp_host ?? '')); ?>"/>
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="form-group col-md-4">
                        ...
                        <input type="text" class="form-control" placeholder="<?php echo app('translator')->get('Available port'); ?>" name="smtp_port" value="<?php echo e(old('smtp_port', $control->email_configuration->smtp_port ?? '')); ?>"/>
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="form-group col-md-4">
                        ...
                        <select name="smtp_encryption" class="form-control" >
                            <option value="tls" <?php if( old('smtp_encryption', $control->email_configuration->smtp_encryption) == "tls"): ?> selected <?php endif; ?>><?php echo app('translator')->get('tls'); ?></option>
                            <option value="ssl" <?php if( old('smtp_encryption', $control->email_configuration->smtp_encryption) == "ssl"): ?> selected <?php endif; ?>><?php echo app('translator')->get('ssl'); ?></option>
                        </select>
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="form-group col-md-6">
                        ...
                        <input type="text" class="form-control" placeholder="<?php echo app('translator')->get('username or Email'); ?>" name="smtp_username" value="<?php echo e(old('smtp_username', $control->email_configuration->smtp_username ?? '')); ?>"/>
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="form-group col-md-6">
                        ...
                        <input type="text" class="form-control" placeholder="<?php echo app('translator')->get('Password'); ?>" name="smtp_password" value="<?php echo e(old('smtp_password', $control->email_configuration->smtp_password ?? '')); ?>"/>
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="form-group ">
                    ...
                    <textarea class="form-control summernote" name="email_description" id="summernote" placeholder="<?php echo app('translator')->get('Email Description'); ?>" rows="20"><?php echo  $email_description ?></textarea>
                </div>
                <button type="submit" class="btn waves-effect waves-light btn-rounded btn-primary btn-block mt-3"><span><?php echo app('translator')->get('Save Changes'); ?></span> </button>
            </form>
        </div>
    </div>
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/sites/28a/2/26dd80d363/public_html/resources/views/admin/email-template/config.blade.php ENDPATH**/ ?>