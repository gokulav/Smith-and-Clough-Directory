                                            ...
                                            <div class="col-md-4 source-parent">
                                                <div class="form-group">
                                                    ...
                                                    <div class="image-input ">
                                                        ...
                                                        <img id="image_preview_container" class="preview-image" src="<?php echo e(getFile(config('location.content.path').(isset($templateMedia->description->{$name}) ? $templateMedia->description->{$name} : ''))); ?>"
...
unset($__errorArgs, $__bag); ?>
                                        ...
                                        <?php elseif($type == 'url'): ?>
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    <label for="<?php echo e($name); ?>"> <?php echo app('translator')->get(ucwords(str_replace('_',' ',$name))); ?> </label>
                                                    <input type="<?php echo e($type); ?>" name="<?php echo e($name); ?>[<?php echo e(0); ?>]"
...
unset($__errorArgs, $__bag); ?>"
                                                           value="<?php echo e(old($name.'.0', isset($templateMedia->description->{$name}) ? $templateMedia->description->{$name} : '')); ?>">
...
unset($__errorArgs, $__bag); ?>"
                                                               value="<?php echo e(old($name.'.0', isset($templates[0]) ? $templates[0][0]->description->{$name} : '')); ?>">
                                                        ...
                                                        <div class="col-md-4 source-parent">
                                                            <div class="form-group">
                                                                ...
                                                                <div class="image-input ">
                                                                    ...
                                                                    <img id="image_preview_container" class="preview-image" src="<?php echo e(getFile(config('location.default'))); ?>"
                                                                         alt="<?php echo app('translator')->get('preview image'); ?>">
                                                                </div>
