                                ...
                                <div class="cover">
                                    <div class="img">
                                        <img id="cover profile-cover-preview" class="profile-cover-preview"
                                             src="<?php echo e(getFile($user->cover_driver, $user->cover_photo)); ?>"
                                ...
                                <div class="profile">
                                    <div class="img">
                                        <img id="profile profile-image-preview" class="profile-image-preview img-fluid"
                                             src="<?php echo e(getFile($user->driver, $user->image)); ?>"
...
unset($__errorArgs, $__bag); ?>
                                    ...
                                    <div>
                                        <h4 class="name">
                                            <?php echo app('translator')->get($user->firstname); ?> <?php echo app('translator')->get($user->lastname); ?>
                                ...
                                <div class="about mt-4">
                                    <div>
                                        <p class="bio">
                                            <?php echo app('translator')->get($user->bio); ?>
                                        </p>

                                        <div class="links">
                                            <?php if($user->website): ?>
                                                <a href="javascript:void(0)" >
                                                    <i class="fas fa-globe" aria-hidden="true"></i><?php echo app('translator')->get($user->website); ?>
                                                </a>
                                            <?php endif; ?>
                                            <?php if($user->address): ?>
                                                <a href="javascript:void(0)" >
                                                    <i class="fas fa-location-arrow"
                                                       aria-hidden="true"></i><?php echo app('translator')->get($user->address); ?>
                                                </a>
                                            <?php endif; ?>

                                            <a href="javascript:void(0)" >
                                                <i class="fas fa-calendar-alt" aria-hidden="true"></i><?php echo app('translator')->get('Joined'); ?> <?php echo e($user->created_at->format('F Y')); ?>
                                ...
                                <div class="counts mt-4">
                                    <div class="count">
                                        ...
                                        <span><?php echo e(count($listing_infos)); ?></span>
                                    </div>
                                    <div class="count">
                                        <?php echo app('translator')->get('Views'); ?>
                                        <span><?php echo e($all_viewers_count); ?></span>
                                    </div>
                                    <div class="count">
                                ...
                                <div class="row g-lg-5">
                                    <div class="col-lg-4">
                                        <div class="sidebar-wrapper mb-3">
                                            <h3><?php echo app('translator')->get('Update Information'); ?></h3>
                                        ...
                                        <div id="tab1"
                                            ...
                                            <form action="<?php echo e(route('user.updateInformation')); ?>" method="post">
                                                ...
                                                <div class="row g-4">
                                                    ...
                                                    <div class="input-box col-md-6">
                                                        <label for=""><?php echo app('translator')->get('Website'); ?></label>
                                                        <input
...
unset($__errorArgs, $__bag); ?>"
                                                            name="website"
                                                            type="text"
                                                            value="<?php echo app('translator')->get($user->website); ?>"
                                                        />
...
unset($__errorArgs, $__bag); ?>"
                                                            ...
                                                            name="address"
                                                            type="text"
                                                            value="<?php echo app('translator')->get(@$user->address); ?>"
                                                        />
...
unset($__errorArgs, $__bag); ?>"
                                                            ...
                                                            rows="3"
                                                            name="bio"
                                                        ><?php echo app('translator')->get(@$user->bio); ?></textarea>
...
unset($__errorArgs, $__bag); ?>
                                                    ...
                                                    <div class="input-box col-12">
                                                        <button class="btn-custom" type="submit"><?php echo app('translator')->get('Update Profile'); ?></button>
                                                    </div>
                                                </div>
                                            </form>
                                        </div>
        ...
        <div class="modal-dialog modal-dialog-centered modal-md">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    ...
                    <button type="button" class="btn-custom cover-photo-save"><?php echo app('translator')->get('Save changes'); ?></button>
                </div>
            </div>
        </div>
    </div>
    ...
    <script>
        ...
        $(document).ready(function () {
            ...
            $('#userCoverPhoto').on('change', function () {
                $('#coverChangeText').text(`<?php echo app('translator')->get('Do you want to change your cover photo?'); ?>`)
            ...
            $(document).on('click', '.cover-photo-save', function () {
                ...
                $.ajax({
                    url: "<?php echo e(route('user.coverPhotoUpdate')); ?>",
                    type: "post",
                    data: formData,
                    async: false,
                    cache: false,
...
<?php echo $__env->make($theme.'layouts.user', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/sites/28a/2/26dd80d363/public_html/resources/views/themes/classic/user/profile/myprofile.blade.php ENDPATH**/ ?>