...
<?php $__env->startSection('content'); ?>
    <div class="card card-primary m-0 m-md-4 my-4 m-md-0 shadow">
        <div class="card-body">
            <?php if(adminAccessRoute(config('role.amenities.access.add'))): ?>
                <div class="media mb-4 float-right">
                    <a href="<?php echo e(route('admin.amenitiesCreate')); ?>" class="btn btn-sm btn-primary mr-2">
            ...
            <div class="table-responsive">
                <table class="categories-show-table table table-hover table-striped table-bordered" id="zero_config">
                    ...
                    <tr>
                        ...
                        <?php if(adminAccessRoute(config('role.amenities.access.edit')) == true || adminAccessRoute(config('role.amenities.access.delete')) == true): ?>
                            ...
                            <tr>
                                ...
                                <?php if(adminAccessRoute(config('role.amenities.access.edit')) == true || adminAccessRoute(config('role.amenities.access.delete')) == true): ?>
                                    <td data-label="<?php echo app('translator')->get('Action'); ?>">
                                        <?php if(adminAccessRoute(config('role.amenities.access.edit')) == true): ?>
                                            <a href="<?php echo e(route('admin.amenitiesEdit',$item->id)); ?>" class="btn btn-sm btn-outline-primary rounded edit-button">
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/sites/28a/2/26dd80d363/public_html/resources/views/admin/amenities/index.blade.php ENDPATH**/ ?>