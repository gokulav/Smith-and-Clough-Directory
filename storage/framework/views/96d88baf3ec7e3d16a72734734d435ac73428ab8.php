                ...
                <table id="zero_config"
                    ...
                    <?php $__currentLoopData = $emailTemplate; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $template): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <tr>
                            ...
                            <td>
                                <span class="badge badge-pill badge-<?php echo e(($template->mail_status == 1) ?'success' : 'danger'); ?>"><?php echo e(($template->mail_status == 1) ?trans('Active') : trans('Deactive')); ?></span>
                            </td>
                            <?php if(adminAccessRoute(config('role.website_controls.access.edit'))): ?>
                            <td>
                                <a  href="<?php echo e(route('admin.email-template.edit',$template->id)); ?>" class="btn btn-sm btn-outline-primary rounded" title="<?php echo app('translator')->get('Edit'); ?>"><i class="fas fa-edit" aria-hidden="true"></i></a>
                            </td>
                            <?php endif; ?>
                        </tr>
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/sites/28a/2/26dd80d363/public_html/resources/views/admin/email-template/show.blade.php ENDPATH**/ ?>