            ...
            <table class="categories-show-table table table-hover table-striped table-bordered" id="zero_config">
                <thead class="thead-dark">
                    <tr>
                        ...
                        adminAccessRoute(config('role.place.access.delete')) == true): ?>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td data-label="<?php echo app('translator')->get('Status'); ?>">
                            <span
                                class="badge badge-pill <?php echo e($item->status == 1 ? 'badge-success' : 'badge-danger'); ?>"><?php echo app('translator')->get($item->status
                                == 1 ? 'Active' : 'Deactive'); ?></span>
                        </td>
                        <?php if(adminAccessRoute(config('role.place.access.edit')) == true ||
                        adminAccessRoute(config('role.place.access.delete')) == true): ?>
                        <td data-label="<?php echo app('translator')->get('Action'); ?>">
                            <?php if(adminAccessRoute(config('role.place.access.edit')) == true): ?>
                            <a href="<?php echo e(route('admin.placeEdit',$item->id)); ?>"
                                class="btn btn-outline-primary btn-sm rounded btn-icon edit_button">
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/sites/28a/2/26dd80d363/public_html/resources/views/admin/place/index.blade.php ENDPATH**/ ?>