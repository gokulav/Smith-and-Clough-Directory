...
<?php $__env->startSection('content'); ?>
    <div class="container-fluid">
        ...
        <form action="<?php echo e(route('user.listingUpdate', $id)); ?>" method="post" enctype="multipart/form-data">
            <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>"
                                               placeholder="<?php echo app('translator')->get('title'); ?>" type="text" name="title"
...
unset($__errorArgs, $__bag); ?>"
                                            ...
                                            data-categories="<?php echo e($single_package_infos->no_of_categories_per_listing); ?>">
                                            <?php $__currentLoopData = $all_listings_category; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <option value="<?php echo e($item->id); ?>"
                                                        <?php $__currentLoopData = $categoryIds; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category_id): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?> <?php if($category_id->id == $item->id): ?> selected <?php endif; ?> <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>>
...
unset($__errorArgs, $__bag); ?>"
                                               placeholder="<?php echo app('translator')->get('email'); ?>" type="email" name="email"
...
unset($__errorArgs, $__bag); ?>" type="text"
                                               placeholder="<?php echo app('translator')->get('phone'); ?>" name="phone"
...
unset($__errorArgs, $__bag); ?>"
                                                    ...
                                                    <?php $__currentLoopData = $all_places; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                        <option value="<?php echo e($item->id); ?>"
                                                                <?php echo e(old('place_id', $item->id) == $single_listing_infos->place_id ? 'selected' : ''); ?> data-name="<?php echo e(optional($item->details)->place); ?>"
                                                                data-lat="<?php echo e($item->lat); ?>"
                                                                data-long="<?php echo e($item->long); ?>">
                                                            <?php echo e(optional($item->details)->place); ?>
...
unset($__errorArgs, $__bag); ?>" id="lat"
                                                       name="lat" value="<?php echo e(old('lat', $single_listing_infos->lat)); ?>"/>
                                                <div class="invalid-feedback">
                                                    <?php $__errorArgs = ['lat'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
...
unset($__errorArgs, $__bag); ?>
                                ...
                                <div class="col-xl-6">
                                    <div id="map">
                                        <p><?php echo app('translator')->get('You can also set location moving marker'); ?></p>
                                    </div>
                                </div>
                            </div>
                        </div>
                                            ...
                                            <div class="d-flex">
                                                <div class="input-box w-100 my-1 me-1">
                                                    <input type="time" name="start_time[]"
                                                           value="<?php echo e(old("start_time.$i", $business_hours[$i]->start_time ?? '')); ?>"
                                    ...
                                    <div class="input-box col-md-12">
                                        <select class="amenities_select2 form-control" name="amenity_id[]" multiple
                                            ...
                                            <?php $__currentLoopData = $all_amenities; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <option
                                                    value="<?php echo e($item->id); ?>" <?php echo e(in_array($item->id, $listing_aminities) ? 'selected' : ''); ?>><?php echo e($item->details->title); ?></option>
                                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                        </select>
                                    </div>
                                </div>
                    ...
                    <div class="main row gy-4 new_product_form">
                        <div class="d-flex justify-content-start">
                            ...
                            <button class="btn-custom-product add-new-product" type="button" id="add_products"
                                ...
                                <i class="fal fa-plus"></i> <?php echo app('translator')->get('Add More'); ?> (<span
                                    class="product_count"><?php if($single_package_infos->no_of_product == null): ?>
                                    ...
                                    <div class="form new__product__form">
                                        ...
                                        <div class="row g-3">
                                            ...
                                            <div class="input-box col-12">
                                                <textarea class="form-control" cols="30" rows="3" name="product_description[]" placeholder="<?php echo app('translator')->get('Description'); ?>"><?php echo e(old("product_description.$i", $listing_products[$i]->product_description ?? '')); ?></textarea>
                                            </div>
                                ...
                                <div class="row g-3">
                                    <div class="input-box col-md-12">
                                        <input class="form-control" type="text" name="meta_title"
                                               value="<?php echo e(old('meta_title', @$listing_seo->meta_title)); ?>"/>
                                    </div>

                                    <div class="input-box col-md-12">
                                        <input class="form-control mb-1 tags_input" type="text" name="meta_keywords"
                                               value="<?php echo e(old('meta_keywords', @$listing_seo->meta_keywords)); ?>"
                                               data-role="tagsinput"/>
                                    </div>

                                    <div class="input-box col-12">
                                        <textarea class="form-control" cols="30" rows="3"
                                                  name="meta_description"><?php echo e(old('meta_description', @$listing_seo->meta_description)); ?></textarea>
                                    </div>
                                </div>
                            </div>
                        </div>
...
unset($__errorArgs, $__bag); ?>"
                                                    ...
                                                    value="<?php echo e(old('whatsapp_number',  $single_listing_infos->whatsapp_number )); ?>"
                                                    placeholder="<?php echo app('translator')->get('whatsapp number'); ?>"/>
                                                <div class="invalid-feedback">
...
unset($__errorArgs, $__bag); ?>"
                                                    ...
                                                    placeholder="<?php echo app('translator')->get('Typically replies within a day'); ?>"/>
                                                <div class="invalid-feedback">
...
unset($__errorArgs, $__bag); ?>
                                            ...
                                            <div class="input-box col-md-12 bg-white p-0">
                                                <textarea
                                                    class="form-control summernote <?php $__errorArgs = ['body_text'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>"
                                                    ...
                                                    value="<?php echo e(old('body_text', $single_listing_infos->body_text )); ?>"><?php echo e(old('body_text', $single_listing_infos->body_text)); ?></textarea>
...
<?php echo $__env->make($theme.'layouts.user', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/sites/28a/2/26dd80d363/public_html/resources/views/themes/classic/user/editListing.blade.php ENDPATH**/ ?>