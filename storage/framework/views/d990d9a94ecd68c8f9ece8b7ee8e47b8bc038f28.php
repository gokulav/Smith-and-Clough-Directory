            ...
            <div class="table-responsive">
                <table class="categories-show-table table table-hover table-striped table-bordered">
                                ...
                                <?php if($ticket->user_id): ?>
                                    <div class="float-left">
                                        <a href="<?php echo e(route('admin.user-edit', $ticket->user_id)); ?>" target="_blank">
                                            <img src="<?php echo e(getFile(optional($ticket->user)->driver, optional($ticket->user)->image)); ?>" alt="<?php echo e(config('basic.site_title')); ?>" class="contactImageUser">
                                        </a>
                                    </div>
                                    <div class="float-left">
                                        <?php echo app('translator')->get(optional($ticket->user)->fullname); ?> <br>
                                        <?php echo app('translator')->get(optional($ticket->user)->email); ?>
                                    </div>
                                <?php else: ?>
                                    <p class="font-weight-bold"> <?php echo app('translator')->get($ticket->name); ?></p>
                                <?php endif; ?>
                            </td>
                    ...
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
                        <tr>
                            <td colspan="100%">
                                <p class="text-danger text-center"><?php echo app('translator')->get($empty_message); ?></p>
                            </td>
                        </tr>
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/sites/28a/2/26dd80d363/public_html/resources/views/admin/ticket/index.blade.php ENDPATH**/ ?>