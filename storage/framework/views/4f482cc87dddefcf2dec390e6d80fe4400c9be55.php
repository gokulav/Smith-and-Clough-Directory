    ...
    <body>
        <div class="main-wrapper">
            ...
            <div class="auth-wrapper d-flex no-block justify-content-center align-items-center position-relative"
                 style="background:url(<?php echo e(getFile(config('basic.default_file_driver'),config('basic.admin_login_bg'))); ?>) no-repeat center center;">
                <div class="auth-box row">
                    <div class="col-lg-6 col-md-5 modal-bg-img"
                         style="background-image: url(<?php echo e(getFile(config('basic.default_file_driver'),config('basic.admin_login_theme'))); ?>);">
                    </div>
...
<?php /**PATH D:\wamp\www\Projects\smith-and-clough-com.stackstaging.com\Live-files-project\Smith-and-Clough-Directory\resources\views/admin/layouts/login.blade.php ENDPATH**/ ?>