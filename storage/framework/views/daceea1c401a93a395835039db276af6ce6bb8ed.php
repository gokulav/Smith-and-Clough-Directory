...
<?php $__env->startSection('content'); ?>
    <div class="container-fluid">
        ...
        <form action="<?php echo e(route('user.listingStore', $id)); ?>" method="post" enctype="multipart/form-data">
            <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>" type="text"
                                               name="title" value="<?php echo e(old('title')); ?>" placeholder="<?php echo app('translator')->get('Title'); ?>"/>
                    ...
                    <?php if($single_package_infos->is_business_hour == 1): ?>
                        <div class="col-xl-6">
                            ...
                            <div class="form business-hour">
                                <div
                                    class="d-sm-flex justify-content-between delete_this <?php $__errorArgs = ['working_day.0'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>">
                                    <div class="input-box w-100 my-1 mx-sm-1">
                                        <select class="js-example-basic-single form-control" name="working_day[]">
                                            <option
                                                value="Monday" <?php echo e(old('working_day.0') == 'Monday' ? 'selected' : ''); ?>><?php echo app('translator')->get('Monday'); ?></option>
                                            <option
                                                value="Tuesday" <?php echo e(old('working_day.0') == 'Tuesday' ? 'selected' : ''); ?>><?php echo app('translator')->get('Tuesday'); ?></option>
                                            <option
                                                value="Wednesday" <?php echo e(old('working_day.0') == 'Wednesday' ? 'selected' : ''); ?>><?php echo app('translator')->get('Wednesday'); ?></option>
                                            <option
                                                value="Thursday" <?php echo e(old('working_day.0') == 'Thursday' ? 'selected' : ''); ?>><?php echo app('translator')->get('Thursday'); ?></option>
                                            <option
                                                value="Friday" <?php echo e(old('working_day.0') == 'Friday' ? 'selected' : ''); ?>><?php echo app('translator')->get('Friday'); ?></option>
                                            <option
                                                value="Saturday" <?php echo e(old('working_day.0') == 'Saturday' ? 'selected' : ''); ?>><?php echo app('translator')->get('Saturday'); ?></option>
                                            <option
                                                value="Sunday" <?php echo e(old('working_day.0') == 'Sunday' ? 'selected' : ''); ?>><?php echo app('translator')->get('Sunday'); ?></option>
                                        </select>
                                        <div class="invalid-feedback">
                                            <?php $__errorArgs = ['working_day.0'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> <?php echo app('translator')->get($message); ?> <?php unset($message);
...
unset($__errorArgs, $__bag); ?>
                                    ...
                                    <div class="d-flex">
                                        <div class="input-box w-100 my-1 me-1">
                                            <input type="time" name="start_time[]" value="<?php echo e(old('start_time.0')); ?>"
                                                   class="form-control <?php $__errorArgs = ['start_time.0'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>"
                                                   placeholder="<?php echo app('translator')->get('Start Hour'); ?>"/>
                                            <div class="invalid-feedback">
...
unset($__errorArgs, $__bag); ?>
                                        ...
                                        <div class="input-box w-100 my-1 me-1">
                                            <input type="time" name="end_time[]" value="<?php echo e(old('end_time.0')); ?>"
                                                   class="form-control <?php $__errorArgs = ['end_time.0'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>
                                ...
                                <div class="new_business_hour_form">
                                    ...
                                    ?>
                                    <?php if($oldWorkingDaysCount > 1): ?>
                                        <?php for($i = 1; $i < $oldWorkingDaysCount; $i++): ?>
                                            <div
...
unset($__errorArgs, $__bag); ?>">
                                                <div class="input-box w-100 my-1 mx-sm-1">
                                                    <select class="js-example-basic-single form-control"
                                                            name="working_day[]">
                                                        <option
                                                            value="Monday" <?php echo e(old("working_day.$i") == 'Monday' ? 'selected' : ''); ?>><?php echo app('translator')->get('Monday'); ?></option>
                                                        <option
                                                            value="Tuesday" <?php echo e(old("working_day.$i") == 'Tuesday' ? 'selected' : ''); ?>><?php echo app('translator')->get('Tuesday'); ?></option>
                                                        <option
                                                            value="Wednesday" <?php echo e(old("working_day.$i") == 'Wednesday' ? 'selected' : ''); ?>><?php echo app('translator')->get('Wednesday'); ?></option>
                                                        <option
                                                            value="Thursday" <?php echo e(old("working_day.$i") == 'Thursday' ? 'selected' : ''); ?>><?php echo app('translator')->get('Thursday'); ?></option>
                                                        <option
                                                            value="Friday" <?php echo e(old("working_day.$i") == 'Friday' ? 'selected' : ''); ?>><?php echo app('translator')->get('Friday'); ?></option>
                                                        <option
                                                            value="Saturday" <?php echo e(old("working_day.$i") == 'Saturday' ? 'selected' : ''); ?>><?php echo app('translator')->get('Saturday'); ?></option>
                                                        <option
                                                            value="Sunday" <?php echo e(old("working_day.$i") == 'Sunday' ? 'selected' : ''); ?>><?php echo app('translator')->get('Sunday'); ?></option>
                                                    </select>
                                                    <div class="invalid-feedback">
                                                ...
                                                <div class="d-flex">
                                                    <div class="input-box w-100 my-1 me-1">
                                                        <input type="time" name="start_time[]"
                                                               value="<?php echo e(old("start_time.$i")); ?>"
                                                               class="form-control <?php $__errorArgs = ["start_time.$i"];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>
                                                    ...
                                                    <div class="input-box w-100 my-1 me-1">
                                                        <input type="time" name="end_time[]"
                                                               value="<?php echo e(old("end_time.$i")); ?>"
                                                               class="form-control <?php $__errorArgs = ["end_time.$i"];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="col-xl-6">
                        <h3 class="mb-3"><?php echo app('translator')->get('Websites And Social Links'); ?></h3>
                        <div class="form website_social_links">
                            <div class="d-flex justify-content-between">
                                <div class="input-group mt-1">
                                    <input type="text" name="social_icon[]"
                                           class="form-control demo__icon__picker iconpicker1 <?php $__errorArgs = ['social_icon.0'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>
                                ...
                                <div class="input-box w-100 my-1 me-1">
                                    <input type="url" name="social_url[]" value="<?php echo e(old('social_url.0')); ?>"
                ...
                <div id="tab5" class="add-listing-form content">
                    <div class="main row gy-4 new_product_form">
                        <div class="d-flex justify-content-start">
                            <h3 class="me-3"><?php echo app('translator')->get('Product'); ?></h3>
                            <button class="btn-custom-product add-new-product" type="button" id="add_products"
                                ...
                                <i class="fal fa-plus"></i> <?php echo app('translator')->get('Add More'); ?> (<span class="product_count"><?php if($single_package_infos->no_of_product == null): ?>
                        ...
                        <div class="col-xl-6 col-md-6 col-sm-12">
                            <div class="form new__product__form">
                                <div class="row g-3">
                                    <div class="input-box col-md-6">
                                        <input class="form-control <?php $__errorArgs = ['product_title.0'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>"
                                               type="text" name="product_title[]" placeholder="<?php echo app('translator')->get('Title'); ?>"
                                               value="<?php echo e(old('product_title.0')); ?>"/>
                                        <?php $__errorArgs = ['product_title.0'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?>
                                    ...
                                    <div class="input-box col-md-6">
                                        <input class="form-control <?php $__errorArgs = ['product_price.0'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>"
                                               ...
                                               placeholder="<?php echo app('translator')->get('Price'); ?>" value="<?php echo e(old('product_price.0')); ?>"/>
                                        <?php $__errorArgs = ['product_price.0'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?>
                                    ...
                                    <div class="input-box col-12 bg-white p-0">
                                        <textarea class="form-control <?php $__errorArgs = ['product_description.0'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" cols="30" rows="3" name="product_description[]" placeholder="<?php echo app('translator')->get('Description'); ?>"><?php echo e(old('product_description.0')); ?></textarea>
                                        <?php $__errorArgs = ['product_description.0'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
                                    ...
                                    <div class="pe-2">
                                        <div class="input-box col-12 no-of-img-per-product">
                                            <div class="product-image no_of_product_image" id="product-image1"
                                                 data-productimage="<?php echo e($single_package_infos->is_product == 1 && $single_package_infos->no_of_img_per_product == null  ? 500 : $single_package_infos->no_of_img_per_product); ?>"></div>
                                            <span
                                                class="text-danger"> <?php $__errorArgs = ['product_image.1.*'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> <?php echo app('translator')->get($message); ?> <?php unset($message);
                                        ...
                                        <div class="form">
                                            <div class="img-box product-thumbnail">
                                                ...
                                                <img id="product_thumbnail"
                                                     src="<?php echo e(asset(getFile(config('location.default')))); ?>"
                                                     class="img-fluid"/>
                                            </div>
                                        </div>

                                        <?php $__errorArgs = ['product_thumbnail.0'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        ?>
                        <?php if($productCounts > 1): ?>
                            <?php for($i = 1; $i < $productCounts; $i++): ?>
                                <div class="col-xl-6 removeProductForm">
                                    <div class="form new__product__form">
                                        ...
                                        <div class="row g-3">
                                            <div class="input-box col-md-6">
                                                <input
                                                    class="form-control <?php $__errorArgs = ['product_title.'.$i];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>"
                                                    type="text" name="product_title[]" placeholder="<?php echo app('translator')->get('Title'); ?>"
                                                    value="<?php echo e(old('product_title.'.$i)); ?>"/>
                                                <?php $__errorArgs = ['product_title.'.$i];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?>
                                            ...
                                            <div class="input-box col-md-6">
                                                <input
                                                    class="form-control <?php $__errorArgs = ['product_price.'.$i];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>"
                                                    ...
                                                    value="<?php echo e(old('product_price.'.$i)); ?>"/>
                                                <?php $__errorArgs = ['product_price.'.$i];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?>
                                            ...
                                            <div class="input-box col-12">
                                                <textarea
                                                    class="form-control <?php $__errorArgs = ['product_description.'.$i];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>"
                                                    ...
                                                    placeholder="<?php echo app('translator')->get('Description'); ?>"><?php echo e(old('product_description.'.$i)); ?></textarea>
                                                <?php $__errorArgs = ['product_description.'.$i];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
                                            ...
                                            <div class="pe-2">
                                                <div class="input-box col-12 no-of-img-per-product">
                                                    <div class="product-image no_of_product_image"
                                                         id="product-image<?php echo e($i + 1); ?>"
                                                         data-productimage="<?php echo e($single_package_infos->is_product == 1 && $single_package_infos->no_of_img_per_product == null  ? 500 : $single_package_infos->no_of_img_per_product); ?>"></div>
                                                    <span
                                                        class="text-danger"> <?php $__errorArgs = ['product_image.'.($i + 1).'.*'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> <?php echo app('translator')->get($message); ?> <?php unset($message);
...
unset($__errorArgs, $__bag); ?></span>
                                            ...
                                            <div class="upload-img thumbnail">
                                                ...
                                                <?php $__errorArgs = ['product_thumbnail.'.$i];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?>"
                                                    ...
                                                    value="<?php echo e(old('whatsapp_number')); ?>" placeholder="<?php echo app('translator')->get('whatsapp number'); ?>"/>
                                                <div class="invalid-feedback">
...
unset($__errorArgs, $__bag); ?>"
                                                    ...
                                                    value="<?php echo e(old('replies_text')); ?>" placeholder="<?php echo app('translator')->get('Typically replies within a day'); ?>"/>
                                                <div class="invalid-feedback">
...
<?php echo $__env->make($theme.'layouts.user', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/sites/28a/2/26dd80d363/public_html/resources/views/themes/classic/user/addListing.blade.php ENDPATH**/ ?>