           ...
           <div class="row">
               <?php if(adminAccessRoute(config('role.language_settings.access.add'))): ?>
                   ...
                   <a href="<?php echo e(route('admin.language.create')); ?>"
                      class="btn btn-sm btn-primary float-right mb-3"><i class="fa fa-plus-circle"></i> <?php echo app('translator')->get('Add New'); ?></a>
                   </div>
               <?php endif; ?>
                   ...
                   <div class="col-md-3">
                       <div class="card shadow border-eee">
                           <div class="card-header bg-white ">
                               <h4 class="py-3 text-primary"><i class="fa fa-folder-open"></i> <?php echo e(kebab2Title($language->name)); ?>

                                   <?php if($language->is_active): ?>
                                       <span class="float-right badge badge-success badge-pill"><?php echo app('translator')->get('Active'); ?></span>
                                   <?php else: ?>
                                       <span class="float-right badge badge-warning badge-pill"><?php echo app('translator')->get('Inactive'); ?></span>
                                   <?php endif; ?>
                               </h4>
                           </div>
                           ...
                           <div class="card-footer bg-white border-top-eee d-flex justify-content-between">
                               ...
                               <a href="<?php echo e(route('admin.language.edit',$language)); ?>" class=" btn-sm btn btn-outline-dark" title="<?php echo app('translator')->get('Edit'); ?>">
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\wamp\www\Projects\smith-and-clough-com.stackstaging.com\Live-files-project\Smith-and-Clough-Directory\resources\views/admin/language/index.blade.php ENDPATH**/ ?>