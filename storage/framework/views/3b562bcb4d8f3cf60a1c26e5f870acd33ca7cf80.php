                    ...
                    <table class="categories-show-table table table-hover table-striped table-bordered">
                        ...
                        <?php $__currentLoopData = $contents; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <tr>
                                ...
                                <?php if(adminAccessRoute(array_merge(config('role.theme_settings.access.edit'), config('role.theme_settings.access.delete')))): ?>
                                    <td>
                                        <?php if(adminAccessRoute(config('role.theme_settings.access.edit'))): ?>
                                            <a href="<?php echo e(route('admin.content.show',[$value,$value->name])); ?>"
                                               class="btn btn-outline-primary btn-sm rounded mr-1"><i
                                                    class="fas fa-edit"></i>
                                        <?php endif; ?>
                                        ...
                                        <?php if(adminAccessRoute(config('role.theme_settings.access.delete'))): ?>
                                            <a href="javascript:void(0)"
                                               ...
                                               class="btn btn-outline-danger btn-sm rounded notiflix-confirm"><i
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\wamp\www\Projects\smith-and-clough-com.stackstaging.com\Live-files-project\Smith-and-Clough-Directory\resources\views/admin/content/index.blade.php ENDPATH**/ ?>