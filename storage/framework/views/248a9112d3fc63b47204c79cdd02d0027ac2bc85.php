            ...
            <div class="navbar-brand">
                <a href="<?php echo e(url('/')); ?>">
                    <span class="logo-text">
                        <img src="<?php echo e(getFile(config('basic.default_file_driver'),config('basic.admin_logo'))); ?>" alt="<?php echo app('translator')->get('homepage'); ?>"
                             class="dark-logo"/>
                        <img src="<?php echo e(getFile(config('basic.default_file_driver'),config('basic.admin_logo'))); ?>" class="light-logo"
                             alt="<?php echo app('translator')->get('homepage'); ?>"/>
                    </span>
                </a>
            </div>
                        ...
                        <form class="navbar-search-form" onsubmit="return false;">
                            <div class="customize-input">
                                <input class="form-control custom-shadow custom-radius border-0 bg-white"
                                       ...
                                       placeholder="<?php echo app('translator')->get('Search'); ?>" aria-label="Search">
                ...
                <li class="nav-item dropdown">
                    <a class="nav-link dropdown-toggle" href="javascript:void(0)" data-toggle="dropdown"
                       aria-haspopup="true" aria-expanded="false">
                        <img src="<?php echo e(getFile(Auth::guard('admin')->user()->driver,Auth::guard('admin')->user()->image)); ?>"
                             alt="<?php echo app('translator')->get('user'); ?>"
...
<?php /**PATH D:\wamp\www\Projects\smith-and-clough-com.stackstaging.com\Live-files-project\Smith-and-Clough-Directory\resources\views/admin/layouts/header.blade.php ENDPATH**/ ?>