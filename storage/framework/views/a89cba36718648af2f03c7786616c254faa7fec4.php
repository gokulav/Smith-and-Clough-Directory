...
<?php $__env->startSection('content'); ?>
    <div class="card card-primary m-0 m-md-4 my-4 m-md-0 shadow">
        <div class="card-body">
            ...
            <?php if(adminAccessRoute(config('role.manage_role.access.add'))): ?>
                <div class="d-flex justify-content-end mb-2 text-right">
                    <button  data-target="#addModal"  data-toggle="modal"  class="btn btn-primary btn-sm"><i class="fa fa-user-plus"></i> <?php echo e(trans('Add New')); ?> </button>
                </div>
            <?php endif; ?>
            ...
            <div class="table-responsive">
                <table class="categories-show-table table table-hover table-striped table-bordered">
                    ...
                    <tr>
                        ...
                        <?php if(adminAccessRoute(config('role.manage_role.access.edit'))): ?>
                    ...
                    <?php $__currentLoopData = $admins; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $k => $data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <tr>
                            ...
                            <td>
                                <span  class="badge  badge-pill  badge-<?php echo e($data->status ==0 ? 'danger' : 'success'); ?>"><?php echo e($data->status == 0 ? 'Deactive' : 'Active'); ?></span>
                            </td>
                            <?php if(adminAccessRoute(config('role.manage_role.access.edit'))): ?>
                                <td data-label="<?php echo app('translator')->get('Action'); ?>">
                                    <button
                                        class="edit_button   btn btn-outline-primary rounded btn-sm "
                                    ...
                                    <div class="modal fade" id="myModal<?php echo e($data->id); ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
                                        ...
                                        <div class="modal-dialog modal-lg">
                                            <div class="modal-content ">
                                                ...
                                                <form role="form" method="POST" class="actionRoute" action="<?php echo e(route('admin.updateStaff',$data)); ?>" enctype="multipart/form-data" >
                                                    <?php echo csrf_field(); ?>
                                                        ...
                                                        <div class="row">
                                                            <div class="form-group col-md-6">
                                                                ...
                                                                <input class="form-control " name="name"
                                                                       placeholder="<?php echo e(trans('Name')); ?>" value="<?php echo e($data->name); ?>" required autocomplete="off">
                                                            </div>
                                                            <div class="form-group col-md-6">
                                                                <label class="text-dark"> <?php echo e(trans('Username')); ?> :</label>
                                                                <input class="form-control " name="username"
                                                                       placeholder="<?php echo e(trans('Username')); ?>" value="<?php echo e($data->username); ?>" autocomplete="off"
                                                                       required>
                                                            </div>
                                                            <div class="form-group col-md-6">
                                                                <label class="text-dark"> <?php echo e(trans('E-Mail')); ?> :</label>
                                                                <input class="form-control " name="email"
                                                                       placeholder="<?php echo app('translator')->get('Email Address'); ?>" value="<?php echo e($data->email); ?>" autocomplete="off"
                                                                       required>
                                                            </div>
                                                            <div class="form-group col-md-6">
                                                                <label class="text-dark"> <?php echo e(trans('Phone')); ?> :</label>
                                                                <input class="form-control " name="phone"
                                                                       placeholder="<?php echo e(trans('Mobile Number')); ?>" value="<?php echo e($data->phone); ?>" autocomplete="off"
                                                                       required>
                                                            </div>
                                                            <div class="form-group col-md-6">
                                                                <label class="text-dark"> <?php echo e(trans('Password')); ?> :</label>
                                                                <input type="password" name="password" placeholder="<?php echo app('translator')->get('Password'); ?>" autocomplete="off"
                                                                       class="form-control" >
                                                            </div>
                                                            <div class="form-group col-md-6">
                                                                ...
                                                                <select name="status" id="event-status"
                                                                    ...
                                                                    <option value="1" <?php if($data->status == '1'): ?> selected <?php endif; ?>>
                                                                ...
                                                                <div class="card">
                                                                    ...
                                                                    <div class="card-body select-all-access">
                                                                        <div class="form-group">
                                                                            <label><input type="checkbox" class="selectAll" name="accessAll"> <?php echo e(trans('Select All')); ?></label>
                                                                        </div>
                                                                        ...
                                                                        <table class=" table table-hover table-striped table-bordered text-center">
                                                                            ...
                                                                            <?php $__currentLoopData = config('role'); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                                                <tr>
                                                                                    <td data-label="" class="text-left"> <?php echo e($value['label']); ?> </td>
                                                                                    <td data-label="View">
                                                                                        <?php if(!empty($value['access']['view'])): ?>
                                                                                            <input type="checkbox" value="<?php echo e(join(',',$value['access']['view'])); ?>" name="access[]"
                                                                                    ...
                                                                                    <td data-label="Add">
                                                                                        <?php if(!empty($value['access']['add'])): ?>
                                                                                            <input type="checkbox" value="<?php echo e(join(',',$value['access']['add'])); ?>" name="access[]"
                                                                                    ...
                                                                                    <td data-label="Edit">
                                                                                        <?php if(!empty($value['access']['edit'])): ?>
                                                                                            <input type="checkbox" value="<?php echo e(join(',',$value['access']['edit'])); ?>" name="access[]"
                                                                                    ...
                                                                                    <td data-label="Delete">
                                                                                        <?php if(!empty($value['access']['delete'])): ?>
                                                                                            <input type="checkbox" value="<?php echo e(join(',',$value['access']['delete'])); ?>" name="access[]"
                                                    ...
                                                    <div class="modal-footer">
                                                        <button type="button" class="btn btn-outline-secondary btn-sm rounded" data-dismiss="modal"><?php echo app('translator')->get('Close'); ?></button>
                                                        <button type="submit" class="btn btn-outline-success btn-sm rounded" ><?php echo app('translator')->get('Update'); ?></button>
                                                    </div>
                                                </form>
                                            </div>
                                        </div>
    ...
    <div class="modal fade" id="addModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content ">
                ...
                <form role="form" method="POST" class="actionRoute" action="<?php echo e(route('admin.storeStaff')); ?>" enctype="multipart/form-data">
                    <?php echo csrf_field(); ?>
                    <div class="modal-body">
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/sites/28a/2/26dd80d363/public_html/resources/views/admin/staff/index.blade.php ENDPATH**/ ?>