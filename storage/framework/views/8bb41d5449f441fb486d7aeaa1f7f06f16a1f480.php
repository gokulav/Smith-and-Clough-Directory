...
<section class="listing-section">
    <div class="container-fluid">
        <div class="row">
            <div class="col-xl-3 col-lg-3 col-sm-12 my-4">
                        ...
                        <div class="filter-box">
                            ...
                            <div class="input-group mb-3">
                                <select class="js-example-basic-single form-control" name="location">
                                    ...
                                    <option value="all" <?php if(request()->location == 'all'): ?> selected <?php endif; ?>><?php echo app('translator')->get('All Location'); ?>
                                    </option>
                                    ...
                                    <option class="m-0" value="<?php echo e($place->id); ?>" <?php if(request()->location == $place->id): ?> selected <?php endif; ?>><?php echo app('translator')->get(optional($place->details)->place); ?>
                                    </option>
                            ...
                            <div class="input-group mb-3">
                                <select class="listing__category__select2 form-control" name="category[]" multiple>
                                    <option value="all" <?php if(request()->category && in_array('all', request()->category)): ?>
                                        selected
                                    ...
                                    <option value="<?php echo e($category->id); ?>" <?php if(request()->category && in_array($category->id, request()->category)): ?>
                                        selected
                        ...
                        <div class="filter-box">
                            ...
                            <div class="input-group mb-3">
                                <select class="js-example-basic-single form-control" name="user">
                                    ...
                                    <option value="<?php echo e($user->id); ?>" <?php if(request()->user == $user->id): ?> selected <?php endif; ?>><?php echo app('translator')->get($user->fullname); ?>
                                    </option>
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                </select>
                            </div>
                        ...
                        <div class="filter-box">
                            ...
                            <div class="check-box">
                                <div class="form-check">
                                    <input class="form-check-input" type="checkbox" value="5" name="rating[]" id="check1" <?php if(isset(request()->rating)): ?>
                                ...
                                <div class="form-check">
                                    <input class="form-check-input" type="checkbox" value="4" name="rating[]" id="check2" <?php if(isset(request()->rating)): ?>
                                    <?php $__currentLoopData = request()->rating; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                ...
                                <div class="form-check">
                                    <input class="form-check-input" type="checkbox" value="3" name="rating[]" id="check3" <?php if(isset(request()->rating)): ?>
                                    <?php $__currentLoopData = request()->rating; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                ...
                                <div class="form-check">
                                    <input class="form-check-input" type="checkbox" value="2" name="rating[]" id="check4" <?php if(isset(request()->rating)): ?>
                                    <?php $__currentLoopData = request()->rating; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                ...
                                <div class="form-check">
                                    <input class="form-check-input" type="checkbox" value="1" name="rating[]" id="check5" <?php if(isset(request()->rating)): ?>
                                    <?php $__currentLoopData = request()->rating; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            ...
            <div class="col-xl-9 col-lg-9 col-sm-12 my-4">
                <?php if( 0 <count($all_listings)): ?> <div class="row g-4">
                    ...
                    <div class="col-xl-4 col-lg-4 col-md-4 col-sm-6 col-xs-12">
                        <div class="listing-box listing-map-box" data-lat="<?php echo e($listing->lat); ?>" data-long="<?php echo e($listing->long); ?>" data-title="<?php echo app('translator')->get( Str::limit($listing->title, 30)); ?>" data-image="<?php echo e(getFile($listing->driver, $listing->thumbnail)); ?>" data-location="<?php echo app('translator')->get($listing->address); ?>" data-route="<?php echo e(route('listing-details',[slug($listing->title), $listing->id])); ?>">
                            <div class="img-box">
                            ...
                            <div class="text-box">
                                <div class="review">
                                    ...
                                    <?php for($j; $j < 5; $j++): ?> <i class="far fa-star"></i>
                                        <?php endfor; ?>
                                        <?php endif; ?>
                                ...
                                $catData = optional($listing)->getCategoriesName();
                                $disableCat = "Sold";

                                if (!str_contains($catData, $disableCat))
                                {
                                    ?>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make($theme.'layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/sites/28a/2/26dd80d363/public_html/resources/views/themes/classic/listing.blade.php ENDPATH**/ ?>