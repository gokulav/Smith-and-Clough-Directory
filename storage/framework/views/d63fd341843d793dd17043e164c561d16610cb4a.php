            ...
            <div class="col-md-6 col-lg-3 ps-lg-5">
                <div class="footer-box">
                    ...
                    <ul>
                        ...
                        <?php if($fldMenuType == 'F' && $fldparentMenu == '3'): ?>
                        <li>
            ...
            <div class="col-md-6 col-lg-3 ps-lg-5">
                <div class="footer-box">
                    ...
                    <ul>
                        ...
                        <?php if($fldMenuType == 'F' && $fldparentMenu == '4'): ?>
                        <li>
                            <a href="<?php echo e(route('getLink', [slug(optional($data->description)->title), $data->content_id])); ?>"><?php echo app('translator')->get(optional($data->description)->title); ?></a>
                        </li>
                        <?php endif; ?>
...
<!-- /FOOTER --><?php /**PATH D:\wamp\www\Projects\smith-and-clough-com.stackstaging.com\Live-files-project\Smith-and-Clough-Directory\resources\views/themes/classic/partials/footer.blade.php ENDPATH**/ ?>