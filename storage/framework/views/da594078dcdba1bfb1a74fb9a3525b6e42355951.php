...
<?php $__env->startSection('content'); ?>
    ...
    <div class="card card-primary m-0 m-md-4 my-4 m-md-0 shadow">
        <div class="card-body">
            <form method="post" action="<?php echo e(route('admin.identify-form.action')); ?>" class="form-row align-items-center ">
                <?php echo csrf_field(); ?>
                    ...
                    <div class="form-group col-md-2">
                            <button type="submit" class="btn btn-primary btn-block  btn-rounded mx-2 mt-4">
                                <span><?php echo app('translator')->get('Save Changes'); ?></span>
                            </button>
                    </div>
    ...
    <div class="card card-primary m-0 m-md-4 my-4 m-md-0 shadow">
        <div class="card-body">
            ...
            <?php if(adminAccessRoute(config('role.identify_form.access.add')) && count($formExist) != count($newArr) ): ?>
                            ...
                            <?php if(adminAccessRoute(config('role.identify_form.access.edit'))): ?>
                                <td data-label="<?php echo app('translator')->get('Action'); ?>">
                                    <a href="javascript:void(0)"
                                       ...
                                       class="btn btn-outline-primary btn-sm rounded editButton"><i class="fa fa-edit"></i></a>
                                </td>
                            <?php endif; ?>
                        </tr>
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/sites/28a/2/26dd80d363/public_html/resources/views/admin/identify/services.blade.php ENDPATH**/ ?>