        ...
        <div class="main row">
            <div class="col-12">
                <div class="d-flex justify-content-between align-items-center">
                    <h3 class="mb-0"><?php echo app('translator')->get('Listings'); ?></h3>
                </div>
                        ...
                        <div class="row g-3">
                            <div class="col-lg-3 col-md-3 col-sm-12">
                                <div class="input-box input-group">
                                    <input type="text" name="name" class="form-control" placeholder="<?php echo app('translator')->get('Search listing'); ?>" value="<?php echo e(old('name',request()->name)); ?>"/>
                                </div>
                            </div>

                            <div class="input-box col-lg-2 col-md-2 col-sm-12">
                                <select class="js-example-basic-single form-control" name="package">
                                    <option value="" selected disabled><?php echo app('translator')->get('Select Package'); ?></option>
                                ...
                                <select name="package" id="package" class="form-control">
                                    ...
                                    <?php $__currentLoopData = $my_packages; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $package): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        ...
                                        <?php if(($package->no_of_listing > 0 || $package->no_of_listing == null) && ($package->expire_date == null ||  \Carbon\Carbon::now() <= \Carbon\Carbon::parse($package->expire_date)) && ($package->status == 1)): ?>
                                            <option value="<?php echo e($package->id); ?>" data-listing="<?php echo e($package->no_of_listing); ?>" data-route="<?php echo e(route('user.addListing', $package->id)); ?>" class="total_listing<?php echo e($package->id); ?>"><?php echo app('translator')->get(optional($package->get_package)->title); ?></option>
                                        <?php endif; ?>
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                </select>
...
<?php echo $__env->make($theme.'layouts.user', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/sites/28a/2/26dd80d363/public_html/resources/views/themes/classic/user/listing.blade.php ENDPATH**/ ?>