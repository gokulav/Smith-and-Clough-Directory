<?php $__env->startSection('title'); ?>
    <?php echo app('translator')->get("Wish List"); ?>
        ...
        <div class="card-body">
            <div class="table-responsive">
                <table class="categories-show-table table table-hover table-striped table-bordered">
                    ...
                    <th><?php echo app('translator')->get('WishList Added'); ?></th>
                    <th><?php echo app('translator')->get('Added-At'); ?></th>
                    ...
                    <?php $__empty_1 = true; $__currentLoopData = $wishLists; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $wishList): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        <tr>
                            <td data-label="<?php echo app('translator')->get('No.'); ?>"><?php echo e(loopIndex($wishLists) + $key); ?></td>

                            <td data-label="<?php echo app('translator')->get('Listing'); ?>">
                                <a href="<?php echo e(route('listing-details',[slug(optional($wishList->get_listing)->title), optional($wishList->get_listing)->id])); ?>" class="color-change-listing" target="_blank"><?php echo app('translator')->get(\Illuminate\Support\Str::limit(optional($wishList->get_listing)->title, 50)); ?></a>
                            </td>

                            <td data-label="Category">
                                <?php echo e(optional($wishList->get_listing)->getCategoriesName()); ?>

                            </td>

                            <td data-label="<?php echo app('translator')->get('Owner'); ?>">
                                <div class="float-left">
                                    <a href="<?php echo e(route('admin.user-edit', optional(optional($wishList->get_listing)->get_user)->id)); ?>" target="_blank">
                                        <img src="<?php echo e(asset(getFile(optional(optional($wishList->get_listing)->get_user)->driver, optional(optional($wishList->get_listing)->get_user)->image))); ?>" alt="" class="contactImageUser">
                                    </a>
                                </div>
                                <div class="float-left">
                                    <?php echo app('translator')->get(optional(optional($wishList->get_listing)->get_user)->firstname); ?> <?php echo app('translator')->get(optional(optional($wishList->get_listing)->get_user)->lastname); ?> <br>
                                    <?php echo app('translator')->get(optional(optional($wishList->get_listing)->get_user)->email); ?>
                                </div>
                            </td>
                            <td data-label="<?php echo app('translator')->get('WishList Added'); ?>">
                                <div class="float-left">
                                    <a href="<?php echo e(route('admin.user-edit', optional($wishList->get_user)->id)); ?>" target="_blank">
                                        <img src="<?php echo e(asset(getFile(optional($wishList->get_user)->driver, optional($wishList->get_user)->image))); ?>" alt="" class="contactImageUser">
                                    </a>
                                </div>
                                <div class="float-left">
                                    <?php echo app('translator')->get(optional($wishList->get_user)->firstname); ?> <?php echo app('translator')->get(optional($wishList->get_user)->lastname); ?> <br>
                                    <?php echo app('translator')->get(optional($wishList->get_user)->email); ?>
                                </div>
                            </td>
                            <td data-label="<?php echo app('translator')->get('Added-At'); ?>"><?php echo e(dateTime($wishList->created_at)); ?></td>
                            <td data-label="<?php echo app('translator')->get('Action'); ?>">
                                <button type="button" class="btn btn-outline-danger btn-sm btn-icon edit_button notiflix-confirm"
                                        data-toggle="modal" data-target="#deleteModal"
                                        data-route="<?php echo e(route('admin.wishListDelete',$wishList->id)); ?>">
                ...
                <?php echo e($wishLists->appends($_GET)->links('partials.pagination')); ?>
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/sites/28a/2/26dd80d363/public_html/resources/views/admin/listing/wishList.blade.php ENDPATH**/ ?>