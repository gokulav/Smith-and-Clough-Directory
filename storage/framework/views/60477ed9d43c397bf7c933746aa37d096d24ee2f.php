<?php $__env->startSection('title'); ?>
    <?php echo app('translator')->get('Edit Listing Category'); ?>
    ...
    <div class="card card-primary m-0 m-md-4 my-4 m-md-0 shadow">
        <div class="card-body">
            <div class="media mb-4 justify-content-end">
                <a href="<?php echo e(route('admin.listingCategory')); ?>" class="btn btn-sm  btn-primary mr-2">
            ...
            <div class="tab-content mt-2" id="myTabContent">
                <?php $__currentLoopData = $languages; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $language): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div class="tab-pane fade <?php echo e($loop->first ? 'show active' : ''); ?>" id="lang-tab-<?php echo e($key); ?>" role="tabpanel">
                        <form method="post" action="<?php echo e(route('admin.listingCategoryUpdate',[$id, $language->id])); ?>" class="mt-4" enctype="multipart/form-data">
                            <?php echo csrf_field(); ?>
                                        ...
                                        <div class="form-group ">
                                            ...
                                            <div class="custom-switch-btn">
                                                ...
                                                <input type="checkbox" name="status" class="custom-switch-checkbox" id="status"
                                                       value="0" <?php if( optional($listingCategoryDetails[$language->id][0]->category)->status == 0):echo 'checked'; endif ?>>
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\wamp\www\Projects\smith-and-clough-com.stackstaging.com\Live-files-project\Smith-and-Clough-Directory\resources\views/admin/listing/listingCategoryEdit.blade.php ENDPATH**/ ?>