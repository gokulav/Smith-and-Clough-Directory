...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div class="input-box col-12">
                                <input class="form-control" type="text" name="subject" value="<?php echo e(old('subject')); ?>"
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div class="input-box col-12">
                                <textarea class="form-control" cols="30" rows="5" name="message"
                                          placeholder="<?php echo app('translator')->get('Message'); ?>"><?php echo e(old('message')); ?></textarea>
...
<?php echo $__env->make($theme.'layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\wamp\www\Projects\smith-and-clough-com.stackstaging.com\Live-files-project\Smith-and-Clough-Directory\resources\views/themes/classic/contact.blade.php ENDPATH**/ ?>