            ...
            <div class="card mb-4 shadow">
                <div class="card-body">
                    <div class="media align-items-center justify-content-between mb-3">
                        ...
                        <a href="<?php echo e(route('admin.content.index',$content->name)); ?>" class="btn btn-sm btn-primary"><i class="fa fa-arrow-left"></i> <?php echo app('translator')->get('Back'); ?></a>
                    </div>

                    <?php if(array_key_exists('language',config("contents.$content->name")) && config("contents.$content->name.language") == 0): ?>
                    <form method="post" action="<?php echo e(route('admin.content.update', [$content,0])); ?>" enctype="multipart/form-data">
                        <?php echo csrf_field(); ?>
                            ...
                            <div class="col-md-4 source-parent">
                                <div class="form-group">
                                    ...
                                    <div class="image-input ">
                                        ...
                                        <img id="image_preview_container" class="preview-image" src="<?php echo e(getFile(@$contentMedia->driver,(isset($contentMedia->description->{$name}) ? @$contentMedia->description->{$name} : ''))); ?>" alt="<?php echo app('translator')->get('preview image'); ?>">
                                    </div>
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    <label for="<?php echo e($name); ?>"> <?php echo app('translator')->get(ucwords(str_replace('_',' ',$name))); ?> </label>
                                    <input type="<?php echo e($type); ?>" name="<?php echo e($name); ?>[0]" class="form-control  <?php $__errorArgs = [$name.'.0'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
...
unset($__errorArgs, $__bag); ?>" value="<?php echo e(old($name.'.0', isset($contentMedia->description->{$name}) ? $contentMedia->description->{$name} : '')); ?>">
...
unset($__errorArgs, $__bag); ?>" value="<?php echo e(old($name.'.0', isset($contentMedia->description->{$name}) ? $contentMedia->description->{$name} : '')); ?>">
                                        <div class="input-group-append">
                                            <button class="btn btn-outline-primary iconPicker" data-icon="<?php echo e(old($name.'.0', isset($contentMedia->description->{$name}) ? $contentMedia->description->{$name} : '')); ?>" role="iconpicker"></button>
                                        </div>
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="tab-content mt-2" id="myTabContent">
                        ...
                        <div class="tab-pane fade <?php echo e($loop->first ? 'show active' : ''); ?>" id="lang-tab-<?php echo e($key); ?>" role="tabpanel">
                            <form method="post" action="<?php echo e(route('admin.content.update', [$content,$language->id])); ?>" enctype="multipart/form-data">
                                <?php echo csrf_field(); ?>
                                <?php echo method_field('put'); ?>
                                <div class="row">
                                    <?php $__currentLoopData = config("contents.$content->name.field_name"); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $name => $type): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
...
unset($__errorArgs, $__bag); ?>" value="<?php echo old($name . '.' . $language->id, isset($contentDetails[$language->id]) ? $contentDetails[$language->id][0]->description->{$name} : '') ?>">
                                            <div class="invalid-feedback">
...
unset($__errorArgs, $__bag); ?>" value="<?php echo e(old($name, isset($contentMedia->description->{$name}) ? $contentMedia->description->{$name} : '')); ?>">
                                                <div class="input-group-append">
                                                    <button class="btn btn-outline-primary iconPicker" data-icon="<?php echo e(old($name, isset($contentMedia->description->{$name}) ? $contentMedia->description->{$name} : '')); ?>" role="iconpicker"></button>
                                                </div>
...
unset($__errorArgs, $__bag); ?>" value="<?php echo e(old($name.'.'.$language->id, isset($contentMedia->description->{$name}) ? $contentMedia->description->{$name} : '')); ?>">
                                            <div class="invalid-feedback">
                                                <?php $__errorArgs = [$name.'.'.$language->id];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
...
unset($__errorArgs, $__bag); ?>" name="<?php echo e($name); ?>[<?php echo e($language->id); ?>]" rows="5"><?php echo e(old($name.'.'.$language->id, isset($contentDetails[$language->id]) ? $contentDetails[$language->id][0]->description->{$name} : '')); ?></textarea>
                                            <div class="invalid-feedback">
                                                <?php $__errorArgs = [$name.'.'.$language->id];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <select name="<?php echo e($name); ?>[<?php echo e($language->id); ?>]" id="<?php echo e($name); ?>" class="form-control">
                                                ...
                                                <option value='H' <?php if($myVariableMenuType=='H' ): ?> selected="selected" <?php endif; ?>>Header</option>
                                                <option value='F' <?php if($myVariableMenuType=='F' ): ?> selected="selected" <?php endif; ?>>Footer</option>
                                            </select>
                                            <div class="invalid-feedback">
                                                <?php $__errorArgs = [$name.'.'.$language->id];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <select name="<?php echo e($name); ?>[<?php echo e($language->id); ?>]" id="<?php echo e($name); ?>" class="form-control">
                                                ...
                                                <option <?php if($myVariableMenuType=='H' ): ?> style="display:block" <?php else: ?> style="display:none" <?php endif; ?> data-group="H" value='1' <?php if($myVariableParentMenu=='1' ): ?> selected="selected" <?php endif; ?>>Selling Your Business</option>
                                                <option <?php if($myVariableMenuType=='H' ): ?> style="display:block" <?php else: ?> style="display:none" <?php endif; ?> data-group="H" value='2' <?php if($myVariableParentMenu=='2' ): ?> selected="selected" <?php endif; ?>>Buying A Business</option>

                                                <option <?php if($myVariableMenuType=='F' ): ?> style="display:block" <?php else: ?> style="display:none" <?php endif; ?> data-group="F" value='3' <?php if($myVariableParentMenu=='3' ): ?> selected="selected" <?php endif; ?>>Quick Links</option>
                                                <option <?php if($myVariableMenuType=='F' ): ?> style="display:block" <?php else: ?> style="display:none" <?php endif; ?> data-group="F" value='4' <?php if($myVariableParentMenu=='4' ): ?> selected="selected" <?php endif; ?>>Our Company</option>
...
unset($__errorArgs, $__bag); ?>
                                ...
                                <button type="submit" class="btn btn-primary btn-sm btn-block"><?php echo app('translator')->get('Save Change'); ?>
                                </button>
                            </form>
                        </div>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\wamp\www\Projects\smith-and-clough-com.stackstaging.com\Live-files-project\Smith-and-Clough-Directory\resources\views/admin/content/show.blade.php ENDPATH**/ ?>