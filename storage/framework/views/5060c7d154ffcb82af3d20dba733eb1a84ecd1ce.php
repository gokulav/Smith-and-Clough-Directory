                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="image-input ">
                                                        ...
                                                        <img id="image_preview_container" class="preview-image"
                                                             src="<?php echo e(getFile(@$contentMedia->driver,(isset($contentMedia->description->{$name}) ? @$contentMedia->description->{$name} : ''))); ?>"
...
unset($__errorArgs, $__bag); ?>
                                                        ...
                                                        <button type="submit"
                                                                class="btn btn-primary btn-sm btn-block"><?php echo app('translator')->get('Save Change'); ?>
                                                        </button>
                                        </form>
                                    </div>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
