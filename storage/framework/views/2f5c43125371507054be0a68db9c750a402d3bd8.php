            ...
            <div class="row justify-content-between mb-3">
                <div class="col-md-4">
                    <button type="button" data-toggle="modal" data-target="#addModal" class="btn btn-sm btn-primary"><i
                            class="fa fa-plus-circle"></i> <?php echo app('translator')->get('Add New Key'); ?> </button>
                </div>
                ...
                <div class="col-md-5">
                    <div class="input-group has_append">
                        ...
                        <div class="input-group-append">
                            <button type="button" class="btn btn-primary import-language"><?php echo app('translator')->get('Import Now'); ?></button>
                        </div>
                    </div>
                    <small
                    ...
                    <div class="modal-body">
                        <div class="form-group ">
                            ...
                            <input type="text" class="form-control form-control-lg" name="value"
                                   placeholder="<?php echo app('translator')->get('Vale'); ?>" value="">
                        </div>
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\wamp\www\Projects\smith-and-clough-com.stackstaging.com\Live-files-project\Smith-and-Clough-Directory\resources\views/admin/language/keyword.blade.php ENDPATH**/ ?>